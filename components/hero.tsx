          ...
          <div className="relative h-96 md:h-full animate-float">
            ...
            <div className="relative bg-card border border-accent/20 rounded-2xl p-8 h-full flex items-center justify-center overflow-hidden">
              <Image
                ...
                placeholder="blur"
                blurDataURL="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNjAwIiBoZWlnaHQ9IjYwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjOGI1Y2Y2Ii8+PC9zdmc+"
              />
            </div>
          </div>
        </div>
